...
public class AssetManager {
    ...
    public static Image buildingWorkshopImg;
    public static Image workshopDepotImg;
    ...
    public static void loadAssets() {
        ...
        buildingWorkshopImg = loadImage("building_workshop.png");
        workshopDepotImg = loadImage("workshop_depot.png");

...
public class Boat {
    public enum VehicleType {
        ROVER("6x6 Land Rover Buggy", 3.6, 0.24, 3.0, 0.988, 115, 56),
        BOAT("Flood Rescue Boat", 7.8, 0.46, 4.3, 0.997, 120, 52),
        HELICOPTER("Emergency Rescue Helicopter", 8.8, 0.52, 4.8, 0.992, 130, 64);
